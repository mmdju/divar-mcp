...
| `find_best_value` | «بهترین X زیر Y تومان» — **انتخاب‌های رتبه‌بندی‌شده، ارزون‌ترین اول**، با قیمت‌های الکی که برچسب می‌خورن نه اینکه برنده بشن |
| `market_price` | **«این قیمت عادیه؟»** — میانهٔ یه نمونهٔ زنده، همراه با تعداد نمونه و چیزهایی که در حساب نیاورده |
