...
The public endpoint is protected by a Cloudflare **Rate Limiting rule** (dashboard: Security → WAF → Rate limiting rules) - enforced at the edge, per client IP, before the Worker runs:
